...
//
//static struct regval_list ov7670_fmt_VGA_RGB565[] = {
//	{ REG_COM7 , 0x04 },
//	{ REG_COM15 , COM15_R00FF | COM15_RGB565 },
//	{ REG_COM10, 0x20}, //PCLK does not toggle on HBLANK.
//	{ REG_RGB444, 0x00 },
//	{ REG_CLKRC, 0x01	 | 0x80 }, // F = XCLK *PLL / (2 * (CLKRC+1))
//
////	{ REG_COM3 , 0x00 },
////	{ REG_COM14, 0x00 },
...
//static struct regval_list ov7670_QVGA_RGB565[] =
//{
//	{REG_COM7, COM7_RGB | COM7_QVGA}, //QVGA and RGB format
//	{REG_COM15, COM15_RGB565 }, //RGB565 output
//
...
//	{REG_COM3, COM3_QVGA | COM3_DCWEN},
//	{REG_COM14, COM14_QVGA},
//
//
//
//	//datasheet: Table 2.2 Resolution Register Settings
//	{REG_SCALING_DCWCTR, SCALING_DCWCTR_QVGA}, //vertical/horizontal down sample by 2
//	{REG_SCALING_PCLK_DELAY, SCALING_PCLK_DELAY_QVGA}, //clock divider: divided by 2
//	{REG_SCALING_PCLK_DIV, SCALING_PCLK_DIV_QVGA},
//	{REG_SCALING_XSC, SCALING_XSC_QVGA}, //horizontal scale factor
//	{REG_SCALING_YSC, SCALING_YSC_QVGA}, //vertical scale factor
//
//	{0xb0, 0x84},
//
...
//	{ REG_RGB444, 0x00 },
	...
	{ REG_HREF, HREF_QVGA},
	{ REG_VSTART, VSTART_QVGA},
	{ REG_VSTOP, VSTOP_QVGA},
	{ REG_VREF, VREF_QVGA},
	{ REG_COM3 , 0x04 },
	{ REG_COM14, 0x19 },
	{ REG_SCALING_XSC , 0x3A },
...
//static struct regval_list ov7670_default_old[] =
//{
//    //--------------------------------------------------------------------------
//    // Gamma curve values
//    //--------------------------------------------------------------------------
